# Orders of deparment of Tribal Development Department Government of Maharashtra

This is a data package repository that process orders obtained from department of Tribal Development Department Government of Maharasthra. The data is obtained by processing orders from Government of Maharashtra's [Orders Website](https://gr.maharashtra.gov.in/1145/Government-Resolutions) website.
...
1. [mahtrib2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahtrib2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahtrib2024.git
```
